...
class RemoveDuplicateFromUnsortedLinkedList(DoublyLinkedList):
...
print("Remove duplicate nodes from unsorted list ::")
remove_duplicate_from_linked_list = RemoveDuplicateFromUnsortedLinkedList()
remove_duplicate_from_linked_list.add_data(12)
remove_duplicate_from_linked_list.add_data(11)
remove_duplicate_from_linked_list.add_data(12)
remove_duplicate_from_linked_list.add_data(21)
remove_duplicate_from_linked_list.add_data(41)
